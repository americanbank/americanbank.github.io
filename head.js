...
CloudflareApps.siteId = "d26052d64a8d39bb69ae390aca165bf0";
...
CloudflareApps.installs["wzFWgm0ANeuS"] = {
    appId: "lMxPPXVOqmoE",
    scope: {}
};;
CloudflareApps.installs["wzFWgm0ANeuS"].options = {
    "id": "UA-29324474-2",
    "social": true
};;
CloudflareApps.installs["yO3uiogIbvL6"] = {
    appId: "XzVIEqe1R2kW",
    scope: {}
};;
CloudflareApps.installs["yO3uiogIbvL6"].options = {
    "ie": 8
};;
if (CloudflareApps.matchPage(CloudflareApps.installs['wzFWgm0ANeuS'].URLPatterns)) {
...
if (CloudflareApps.matchPage(CloudflareApps.installs['wzFWgm0ANeuS'].URLPatterns)) {
    (function() {
        var options = CloudflareApps.installs['wzFWgm0ANeuS'].options
    ...
    script.src = '/cdn-cgi/apps/body/tKgTXoJ6XUODpcRMqYibO1qw1wA.js';
