...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.version=1.036;
		Game.beta=0;
		l('versionNumber').innerHTML='Vsauce clicker v.'+1+(Game.beta?' <span style="color:#ff0;">beta</span>':'');
		...
		l('links').innerHTML='<a href="https://americanbank.github.io" target="blank">Refresh</a>';
		...
		Game.cookies=10000;//cookies
		Game.cookiesd=10000;//cookies display
		Game.cookiesPs=10000;//cookies per second (to recalculate with every new purchase)
		...
		Game.getNewTicker=function()
		{
			...
			if (list.length==0)
			{
				if (Game.cookiesEarned<5) list.push('You feel like making classic. But nobody wants to eat your vsauces.');
				else if (Game.cookiesEarned<50) list.push('Your first batch goes to the trash. The neighborhood raccoon barely touches it.');
				else if (Game.cookiesEarned<100) list.push('Your family accepts to try some of your vsauces.');
				else if (Game.cookiesEarned<500) list.push('Your vsauces are popular in the neighborhood.');
				else if (Game.cookiesEarned<1000) list.push('People are starting to talk about your vsauces.');
				else if (Game.cookiesEarned<3000) list.push('Your vsauces are talked about for miles around.');
				else if (Game.cookiesEarned<6000) list.push('Your vsauces are renowned in the whole town!');
				else if (Game.cookiesEarned<10000) list.push('Your vsauces bring all the boys to the yard.');
				else if (Game.cookiesEarned<20000) list.push('Your vsauces now have their own website!');
				else if (Game.cookiesEarned<30000) list.push('Your vsauces are worth a lot of money.');
				else if (Game.cookiesEarned<40000) list.push('Your vsauces sell very well in distant countries.');
				else if (Game.cookiesEarned<60000) list.push('People come from very far away to get a taste of your vsauces.');
				else if (Game.cookiesEarned<80000) list.push('Kings and queens from all over the world are enjoying your vsauces.');
				else if (Game.cookiesEarned<100000) list.push('There are now museums dedicated to your vsauces.');
				else if (Game.cookiesEarned<200000) list.push('A national day has been created in honor of your vsauces.');
				else if (Game.cookiesEarned<300000) list.push('Your vsauces have been named a part of the world wonders.');
				else if (Game.cookiesEarned<450000) list.push('History books now include a whole chapter about your vsauces.');
				else if (Game.cookiesEarned<600000) list.push('Your vsauces have been placed under government surveillance.');
				else if (Game.cookiesEarned<1000000) list.push('The whole planet is enjoying your vsauces!');
				else if (Game.cookiesEarned<5000000) list.push('Strange creatures from neighboring planets wish to try your vsauces.');
				else if (Game.cookiesEarned<10000000) list.push('Elder gods from the whole cosmos have awoken to taste your vsauces.');
				else if (Game.cookiesEarned<30000000) list.push('Beings from other dimensions lapse into existence just to get a taste of your vsauces.');
				else if (Game.cookiesEarned<100000000) list.push('Your vsauces have achieved sentience.');
				else if (Game.cookiesEarned<300000000) list.push('The universe has now turned into cookie dough, to the molecular level.');
				else if (Game.cookiesEarned<1000000000) list.push('Your vsauces are rewriting the fundamental laws of the universe.');
				else if (Game.cookiesEarned<10000000000) list.push('A local news station runs a 10-minute segment about your vsauces. Success!<br><span style="font-size:50%;">(you win a cookie)</span>');
	...
	Game.Logic=function()
	{
		...
		if (Game.T%(Game.fps)==0) document.title=Beautify(Game.cookies)+' '+(Game.cookies==1?'cookie':'cookies')+' - Vsauce Clicker';
	...
	Game.Draw=function()
	{
		...
		var unit=(Math.round(Game.cookiesd)==1?' cookie':' vsauces');
